...
Dit document beschrijft de technologie architectuur van Koppeltaal GGZ versie 1.3.x. De technologie architectuur voor Koppeltaal als geheel is beperkt omdat Koppeltaal geen uitspraken doet over de technische manier waarop de deelnemende systemen gerealiseerd moeten worden, maar alleen over technische aspecten van de uitwisseling.

Dit document is opgesteld onder verantwoording van VZVZ. De scope is een beschrijving van de architectuur op 'Enterprise Architectuur' niveau, waarbij het TOGAF-raamwerk, en de Architectuur Development Methode \(ADM\) zoveel mogelijk gebruikt worden als taal voor vastlegging van de architectuur.
...
![FHIR Messaging over HTTP](.gitbook/assets/2.jpeg)
...
![FHIR resources](.gitbook/assets/3.jpeg)
...
| :--- | :--- |
| [http://fhir.vitalhealthsoftware.com/Profile/Conformance\#Launch](http://fhir.vitalhealthsoftware.com/Profile/Conformance#Launch
...
![Applicatiemodel](.gitbook/assets/4.jpeg)
...
Elk bericht dat gestuurd wordt door een applicaties, heeft een versie id als het om een wijziging gaat van gegevens \(focal resources\). Elke andere applicatie dat hetzelfde type bericht stuurt zal een subscriptie \(abonnement\) voor dit type bericht moeten hebben, om de versie id van zijn eigen interne resource ‘up-to-date’ te houden met dat van anderen. Elk bericht dat verstuurd wordt, moet de laatste versie id gebruiken, dat door Koppeltaal wordt uitgegeven. Koppeltaal zal van elk binnenkomend bericht de versie id controleren met wat Koppeltaal zelf heeft uitgegeven, en het bericht pas accepteren als de versie id’s van de focal resources gelijk zijn.
...
![Verwerkingsstatus](.gitbook/assets/5.jpeg)
...
![SMART Autorisatie sequence](.gitbook/assets/6.jpeg)
...
![Opbouw FHIR DSTU1 bericht](.gitbook/assets/image%20%281%29.png)
...
![Verschillende type referenties vanuit MessageHeader ](.gitbook/assets/image.png)
